...
def visualize(image_root, foreground_grabcut_root=None, foreground_dl_root=None, partmask_root=None):
    ...
    for i in range(5):
        ...
        fig = plt.figure()
        ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 0 + 1);
        ax.axis('off')
        ax.text(0.95, 0.5, "Image", horizontalalignment='right', verticalalignment='center', transform=ax.transAxes,
                fontsize=12)
        ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 1 + 1);
        ax.axis('off')
        ax.text(0.95, 0.5, "GrabCut", horizontalalignment='right', verticalalignment='center', transform=ax.transAxes,
                fontsize=12)
        ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 2 + 1);
        ax.axis('off')
        ax.text(0.95, 0.5, "DL", horizontalalignment='right', verticalalignment='center', transform=ax.transAxes,
                fontsize=12)
        ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 3 + 1);
        ax.axis('off')
        ax.text(0.95, 0.5, "Front", horizontalalignment='right', verticalalignment='center', transform=ax.transAxes,
                fontsize=12)
        ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 4 + 1);
        ax.axis('off')
        ax.text(0.95, 0.5, "Rear", horizontalalignment='right', verticalalignment='center', transform=ax.transAxes,
                fontsize=12)
        ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 5 + 1);
        ax.axis('off')
        ax.text(0.95, 0.5, "Side", horizontalalignment='right', verticalalignment='center', transform=ax.transAxes,
                fontsize=12)

        for idx, fn in enumerate(fns):
            image = Image.open(fn)
            image = np.array(image.resize((192, 192))) / 255
            ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 0 + idx + 2);
            ax.axis('off')
            ax.imshow(image)
            ...
            if (foreground_grabcut_root != None):
                ...
                ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 1 + idx + 2);
                ax.axis('off')
            ...
            if (foreground_dl_root != None):
                ...
                ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 2 + idx + 2);
                ax.axis('off')
            ...
            if (partmask_root != None):
                ...
                ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 3 + idx + 2);
                ax.axis('off')
                ...
                ax = fig.add_subplot(6, num_sample + 1, (num_sample + 1) * 4 + idx + 2);
                ax.axis('off')
